...
def draft_reply_prompt(
    ...
    *,
    ...
    return (
        ...
        "MANDATORY FORMAT: separate the greeting, each body paragraph, and the closing "
        "with a BLANK LINE (i.e. use '\\n\\n', not a single '\\n'). Example:\n"
        "  Bonjour Charlotte,\\n\\nLe sujet des surcotisations nous concerne — "
        "nous avons N salariés.\\n\\nJe suis preneur d'un échange de vive voix "
        "cette semaine.\\n\\nBien à vous,\\n\\nMichel-Marie\n"
        "Do NOT collapse the greeting onto the same line as the first body paragraph. "
        "Do NOT collapse the closing formula onto the same line as the last body paragraph.\n"
